...
def readings_hook(source):
    ...
    source=re.sub(r'oportunidades\.(js|css)\?v=[^"\s]+',r'oportunidades.\1?v=20260909r10',source)
    source=re.sub(r'oportunidades-ficha.js\?v=[^"\s]+','oportunidades-ficha.js?v=20260909r10',source)
    ...
    if 'src="oportunidades-ficha.js?' not in source:
        source=replace_once(source,'<script src="oportunidades.js?', '<script src="oportunidades-ficha.js?v=20260909r10"></script>\n<script src="oportunidades.js?')
