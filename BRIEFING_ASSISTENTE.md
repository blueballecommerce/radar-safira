...
| `oportunidades.js`, `oportunidades.css`, `oportunidades-ficha.js` | Aba Oportunidade de fornecedores: Etapa 1, cartões compactos que abrem a ficha e comparação de fotos por anúncio, contas compartilhadas, até 40 dias de criação e 1 venda/dia. Integração/publicação: `scripts/integrar_oportunidades.py` e `scripts/publicar_oportunidades.py`. |
