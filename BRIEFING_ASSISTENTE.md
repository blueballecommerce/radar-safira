...
| `oportunidades.js`, `oportunidades.css`, `oportunidades-ficha.js` | Aba Oportunidade de fornecedores: Etapa 1, cartões compactos que abrem a ficha, busca geral do Mercado Livre, categorias com taxas e comparação de fotos por anúncio, contas compartilhadas, menos de 45 dias desde a criação e 1 venda/dia. Integração/publicação: `scripts/integrar_oportunidades.py` e `scripts/publicar_oportunidades.py`. |
