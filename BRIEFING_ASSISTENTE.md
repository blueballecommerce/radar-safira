...
| `oportunidades.js`, `oportunidades.css` | Aba Oportunidade de fornecedores: Etapa 1, contas compartilhadas, até 40 dias de criação e 1 venda/dia. Integração/publicação: `scripts/integrar_oportunidades.py` e `scripts/publicar_oportunidades.py`. |
