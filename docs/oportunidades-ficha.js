...
(function(){
  ...
  function decorate(root,p){
    ...
    const back=document.createElement('button');back.className='btn ghost ot-back';back.textContent='← Oportunidade de fornecedores';back.onclick=()=>showTab('oport');root.prepend(back);
